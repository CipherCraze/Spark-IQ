...
When users ask about the current time or date, always provide this information in your response. The time is in 12-hour format with AM/PM.`
  ...
  useEffect(() => {
    ...
    const initialPrompt = `Hello! I'm Sparky, your AI assistant. I can help with math and science problems, provide current date/time information, and share the latest news. I'll format equations properly:

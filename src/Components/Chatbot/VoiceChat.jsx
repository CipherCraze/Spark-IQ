...
const VoiceChat = () => {
  ...
  const handleSendMessage = async (text) => {
    ...
    try {
      ...
      const aiResponse = {
        text: "I'm here to help you with your studies...",
        sender: 'assistant',
        timestamp: new Date().toISOString(),
      };
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900">
      ...
      <div className="bg-gray-800 p-4 border-b border-gray-700">
        <h1 className="text-xl font-semibold text-white">Student Voice Chat</h1>
        <p className="text-sm text-gray-400">Speak to Sparky for study assistance</p>
      </div>

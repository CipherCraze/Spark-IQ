...
import { auth, googleProvider } from '../firebase/firebaceConfig'; // Import auth and googleProvider
import { signInWithPopup } from 'firebase/auth'; // Import the signInWithPopup method for Google SignIn
...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      const user = result.user; // User info from Google login
      console.log(user); // You can log user details here or navigate after successful login
  ...
  // Handle manual form submission (if you want to keep email/password login)
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-4">
      <div className="w-full max-w-md space-y-8 bg-gray-800 rounded-xl shadow-2xl p-8 border border-gray-700">
        ...
        {/* Existing form for email/password */}

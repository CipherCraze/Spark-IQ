      ...
      <div className="mx-auto w-full max-w-6xl space-y-6">
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-4 md:p-6 border border-gray-700/50">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <button className="px-4 py-2 md:px-6 md:py-3 bg-purple-500/20 text-purple-300 rounded-xl hover:bg-purple-500/30 transition-all flex items-center gap-2">
        ...
        {activeTab === 'resources' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockData.learningResources.map((resource, index) => (
              <div
                key={index}
                className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-4 md:p-6 border border-gray-700/50 hover:border-purple-400/30 transition-all group"
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-purple-500/20 rounded-lg">
                    <BookOpenIcon className="w-5 h-5 md:w-6 md:h-6 text-purple-400" />
                  </div>
                  <div className="flex-1">
                ...
                <button className="mt-4 w-full py-2 text-center bg-gray-700/50 rounded-lg hover:bg-gray-700/70 transition-all text-sm md:text-base">
                  Explore Resource
                </button>
              </div>
            ))}
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-4 md:p-6 border border-gray-700/50">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button className="flex-1 px-4 py-2 bg-purple-500/20 text-purple-300 rounded-lg hover:bg-purple-500/30 transition-all text-sm md:text-base">
              Request Examples
            </button>
          </div>
        </div>

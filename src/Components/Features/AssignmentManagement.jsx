      ...
      >
        ...
        <div className="p-4 border-t border-gray-700/60">
          <button 
            ...
            className="w-full flex items-center gap-3.5 px-3.5 py-2.5 text-red-400 hover:bg-red-500/20 hover:text-red-300 rounded-lg transition-colors duration-200 group"
          >
            <ArrowTrendingUpIcon className="w-5 h-5 transform rotate-180 group-hover:text-red-300" /> {/* Better: ArrowLeftOnRectangleIcon */}
